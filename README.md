...
- **Hôm nay (trên máy này)**: token Claude Code dùng trong ngày (in/out/cache) kèm **breakdown theo từng model** (tự nhận diện model mới), quy đổi ≈ giá API (tham khảo)
- **Lịch sử chi phí (24h / 7 ngày / 30 ngày)**: biểu đồ chi phí Claude Code quy đổi theo giá API — khung 24h theo giờ, 7/30 ngày theo ngày, kèm tổng từng khoảng
